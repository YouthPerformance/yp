...
const disciplines = [
  ...
  },
  {
    name: "Science",
    slug: "science",
    description: "Discover the natural world through empirical investigation",
    icon: "flask",
    color: "#10B981",
    display_order: 3,
  },
  ...
  },
  {
    ...
    description: "Study society and human relationships",
    icon: "users",
    color: "#EC4899",
    display_order: 5,
  },
  {
    name: "Humanities",
    slug: "humanities",
    description: "Explore human culture and expression",
    icon: "pen",
    color: "#8B5CF6",
    display_order: 6,
  },
  {
    name: "Mathematics",
    slug: "mathematics",
    description: "The language of logic and patterns",
    icon: "calculator",
    color: "#06B6D4",
    display_order: 7,
  },
...
const instructors = [
  ...
  },
  {
    ...
    biography:
      'Dr. Keith Campbell is a professor of psychology at the University of Georgia and a leading researcher on narcissism, self-esteem, and generational differences. He is the author of "The Narcissism Epidemic" and has published extensively on the psychology of self-perception and social behavior.',
  ...
  },
  {
    ...
    biography:
      'Dr. Heather Heying is an evolutionary biologist, author, and former professor. She conducted extensive fieldwork in Madagascar studying poison frogs and has published research on evolution, ecology, and behavior. She co-authored "A Hunter-Gatherer\'s Guide to the 21st Century" with her husband Bret Weinstein.',
...
for (const i of instructors) {
  const result = insertInstructor.run(
    i.name,
    i.title,
    i.credentials,
    i.university_affiliations,
    i.biography,
    i.photo_url,
    i.social_links,
  );
...
const courses = [
  {
    ...
    description:
      "This course explores the significance of mythology, religion, and story in the development of personal meaning and psychological stability. Using sources ranging from ancient myths to modern literature, Dr. Peterson examines the archetypal patterns that underlie human experience and guide our actions. Students will learn to recognize these patterns in their own lives and understand how they shape culture and individual psychology.",
    short_description:
      "Explore the profound significance of mythology and story in human psychology.",
  ...
  },
  {
    ...
    description:
      "A comprehensive examination of personality psychology, this course covers major theories from Freud to the Big Five, exploring how personality develops, functions, and can be transformed. Dr. Peterson integrates clinical experience with research findings to provide a deep understanding of human character and its potential for change.",
    short_description:
      "Understand the major theories of personality psychology and human transformation.",
  ...
  },
  {
    ...
    description:
      "Dr. Campbell, a leading researcher on narcissism, provides a comprehensive exploration of narcissistic personality traits and their impact on individuals and society. The course covers the spectrum from healthy self-esteem to pathological narcissism, examining causes, consequences, and cultural factors.",
  ...
  },
  {
    ...
    description:
      "A foundational course covering the major topics in psychology including perception, learning, memory, emotion, personality, and social behavior. This course provides the essential framework for understanding human thought and behavior.",
  ...
  },
  {
    ...
    description:
      "What does it mean to be intelligent? This course examines the nature of intelligence from cognitive, developmental, and evolutionary perspectives. Topics include IQ, multiple intelligences, artificial intelligence, and the relationship between intelligence and wisdom.",
  ...
  },
  {
    ...
    description:
      "Journey through the foundations of Western thought from the Pre-Socratics to the Hellenistic schools. This course examines the ideas of Socrates, Plato, Aristotle, and their predecessors and successors, establishing the philosophical framework that continues to shape our world.",
  ...
  },
  {
    ...
    description:
      "Master the principles of sound reasoning. This course covers formal and informal logic, argument analysis, fallacy identification, and critical thinking skills essential for academic and everyday life.",
  ...
  },
  {
    ...
    description:
      "Trace the intellectual roots of postmodernism from the Counter-Enlightenment to its contemporary manifestations. Dr. Hicks examines how postmodern philosophy emerged and why it has become influential in academia and beyond.",
  ...
  },
  {
    ...
    course_code: "SCI 210",
    description:
      "Explore the principles of evolution and their application to understanding life on Earth. Dr. Heying covers natural selection, adaptation, speciation, and the evolutionary approach to understanding behavior, drawing on her extensive field research.",
  ...
  },
  {
    ...
    course_code: "SCI 305",
    description:
      "Examine how game theory illuminates evolutionary processes and social behavior. Dr. Weinstein explores cooperation, competition, and the evolution of social strategies using mathematical and biological frameworks.",
  ...
  },
  {
    ...
    course_code: "SCI 180",
    description:
      "Discover the science connecting nutrition to cognitive function and brain health. Max Lugavere presents evidence-based strategies for optimizing brain performance and reducing dementia risk through diet and lifestyle choices.",
  ...
  },
  {
    ...
    description:
      "Examine the psychological dimensions of money, status, and material success. This course explores how wealth affects happiness, relationships, and personal development, drawing on research in social psychology and behavioral economics.",
  ...
  },
  {
    ...
    course_code: "HUM 301",
    description:
      "A psychological exploration of the biblical stories of Genesis. Dr. Peterson examines these ancient narratives as profound psychological documents, revealing timeless wisdom about human nature, morality, and meaning.",
...
const courseLectures = [
  {
    ...
    lectures: [
      {
        title: "Introduction: The Problem of Meaning",
        chapter_name: "Part I: The Foundations",
        duration_minutes: 60,
      },
      {
        title: "Mythology, Symbolism, and the Brain",
        chapter_name: "Part I: The Foundations",
        duration_minutes: 55,
      },
      {
        title: "Neuropsychology of Motivation",
        chapter_name: "Part I: The Foundations",
        duration_minutes: 50,
      },
      { title: "The Genesis Story", chapter_name: "Part II: The Stories", duration_minutes: 65 },
      {
        title: "Adam and Eve: Consciousness and Death",
        chapter_name: "Part II: The Stories",
        duration_minutes: 70,
      },
      {
        title: "Cain and Abel: Good, Evil, and Identity",
        chapter_name: "Part II: The Stories",
        duration_minutes: 60,
      },
      {
        title: "The Flood: Chaos and Renewal",
        chapter_name: "Part II: The Stories",
        duration_minutes: 55,
      },
      { title: "The Tower of Babel", chapter_name: "Part II: The Stories", duration_minutes: 50 },
      {
        title: "Abraham: Individual and Culture",
        chapter_name: "Part III: The Individual",
        duration_minutes: 65,
      },
      {
        title: "Heroism and Meaning",
        chapter_name: "Part III: The Individual",
        duration_minutes: 60,
      },
    ],
  },
  {
    ...
    lectures: [
      ...
      {
        title: "Historical Perspectives: Freud",
      ...
      {
        title: "The Big Five: Conscientiousness",
        chapter_name: "Trait Theory",
        duration_minutes: 40,
      },
  ...
  },
  {
    ...
    lectures: [
      ...
      {
        title: "The Narcissism Spectrum",
        chapter_name: "Understanding Narcissism",
        duration_minutes: 50,
      },
      {
        title: "Causes and Development",
        chapter_name: "Understanding Narcissism",
        duration_minutes: 55,
      },
  ...
  },
  {
    ...
    lectures: [
      {
        title: "Introduction: The Meaning Crisis",
        chapter_name: "Part I: Ancient Wisdom",
        duration_minutes: 55,
      },
      {
      ...
      {
        title: "Aristotle, Kant, and Wisdom",
        chapter_name: "Part I: Ancient Wisdom",
        duration_minutes: 55,
      },
      {
        title: "The Hellenistic Domicide",
        chapter_name: "Part II: The Crisis",
        duration_minutes: 50,
      },
      {
        title: "Christianity and the Grammar of Meaning",
        chapter_name: "Part II: The Crisis",
        duration_minutes: 60,
      },
      {
      ...
      {
        title: "Descartes and the Meaning Crisis",
        chapter_name: "Part II: The Crisis",
        duration_minutes: 50,
      },
      { title: "Hegel and Romanticism", chapter_name: "Part III: Response", duration_minutes: 60 },
      {
        ...
        chapter_name: "Part III: Response",
        duration_minutes: 65,
      },
      {
        title: "Awakening: Wisdom and Transformation",
        chapter_name: "Part III: Response",
        duration_minutes: 70,
      },
    ],
...
const faqItems = [
  {
    ...
    answer:
      "A Peterson Academy subscription costs $399 per year. This gives you unlimited access to all courses, including new courses added throughout the year.",
    category: "Pricing",
    sort_order: 1,
  },
  {
  ...
  },
  {
    ...
    answer:
      "We offer a 30-day money-back guarantee. If you are not satisfied with your subscription, contact our support team within 30 days of purchase for a full refund.",
    category: "Pricing",
    sort_order: 3,
  },
  {
    ...
    answer:
      "Peterson Academy is available on any device with a modern web browser, including computers, tablets, and smartphones. We also have iOS and Android apps available.",
    category: "Technical",
    sort_order: 4,
  },
  {
    ...
    answer:
      "Yes, with a subscription you can download lectures for offline viewing through our mobile apps.",
    category: "Technical",
    sort_order: 5,
  },
  {
    ...
    answer:
      "Yes, you receive a certificate of completion when you finish a course. These certificates can be shared on LinkedIn and other platforms.",
    category: "Content",
    sort_order: 6,
  },
  {
    ...
    answer:
      "We add new courses regularly, with new content from world-class professors being added every month. All new content is included in your subscription.",
    category: "Content",
    sort_order: 7,
  },
  {
    ...
    answer:
      "Yes! Gift subscriptions are available and make a wonderful present for the intellectually curious. Visit our gift page to purchase.",
    category: "Pricing",
    sort_order: 8,
  },
];
