...
export const PILLS_CONFIG = {
  ...
  categories: [
    {
      ...
      pills: [
        {
          id: "stability",
          label: "Stop rolling ankles",
          helper: "Build ankle stability for cuts + landings.",
          tag: "stability",
        },
        {
          id: "balance",
          label: "Better balance",
          helper: "Steady on one leg. Better control under load.",
          tag: "balance",
        },
        {
          id: "quiet_landings",
          label: "Quieter landings",
          helper: "Land softer and quieter (less slam).",
          tag: "quiet_landings",
        },
        {
          id: "foot_strength",
          label: "Stronger feet + calves",
          helper: "Wake up the base and build strength safely.",
          tag: "foot_strength",
        },
      ],
    },
      ...
      pills: [
        {
          ...
          helper: "Explode without losing control.",
          tag: "first_step",
        },
        {
          id: "change_direction",
          label: "Quicker cuts",
          helper: "Sharper direction changes with less wobble.",
          tag: "change_direction",
        },
        {
          id: "deceleration",
          label: "Better stopping",
          helper: "Decelerate cleanly. Stronger stops.",
          tag: "deceleration",
        },
      ],
    },
    {
      ...
      pills: [
        {
          id: "jump_power",
          label: "Jump higher (safe)",
          helper: "Build bounce with clean takeoff + landings.",
          tag: "jump_power",
        },
      ],
    },
      ...
      pills: [
        {
          ...
          helper: "Low-impact options that don't annoy neighbors.",
          tag: "apartment_quiet",
        },
        {
          id: "return_carefully",
          label: "Coming back carefully",
          helper: "Rebuilding after a tweak. Step-by-step.",
          tag: "return_carefully",
        },
        {
          id: "reduce_soreness",
          label: "Reduce soreness",
          helper: "Start gentle. Build tolerance the right way.",
          tag: "reduce_soreness",
        },
        {
          id: "routine",
          label: "Build a routine",
          helper: "A plan you can actually repeat (3x/week).",
          tag: "routine",
        },
      ],
    },
  ...
  basketballAddOns: {
    ...
    pills: [
      {
        id: "bball_footwork",
        label: "Better footwork",
        helper: "Court-ready movement patterns.",
        tag: "bball_footwork",
      },
      {
        id: "bball_handles",
        label: "Better handles",
        helper: "Stable base for ball control.",
        tag: "bball_handles",
      },
      {
        id: "bball_shooting",
        label: "More consistent shooting",
        helper: "Better balance = better shot.",
        tag: "bball_shooting",
      },
      {
        id: "bball_lateral",
        label: "Quicker defense slides",
        helper: "Faster lateral movement.",
        tag: "bball_lateral",
      },
    ],
  },
...
export const LANE_CONFIG = {
  ...
  rules: [
    ...
    {
      ifTagAny: ["bball_footwork", "bball_handles", "bball_shooting", "bball_lateral"],
      lane: "base_lane",
    },
  ],
...
export function determineLane(selectedGoals = [], space = null, painFlag = null) {
  ...
  for (const rule of LANE_CONFIG.rules) {
    ...
    if (rule.ifSpaceIs?.includes(space)) {
      return rule.lane;
    }
  }
...
export function generateWolfFirstMessage(data) {
  const { childNickname = "your athlete", ageBand, space, goals = [], lane } = data;

  const goalLabels =
    goals
      .map((g) => g.label || g)
      .slice(0, 3)
      .join(", ") || "building a strong foundation";
  const spaceLabel =
    space === "apartment"
      ? "a smaller space"
      : space === "gym"
