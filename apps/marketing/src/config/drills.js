...
export const DRILLS = {
  ...
  tripod_activation: {
    ...
    category: "foundation",
    instruction:
      "Stand barefoot. Press big toe, pinky toe, and heel into the floor equally. Feel the arch lift slightly.",
  ...
  supported_single_leg_balance: {
    ...
    category: "foundation",
    instruction:
      "Stand on one foot with fingertips lightly touching a wall or chair. Focus on stability without relying on support.",
  ...
  ankle_circles: {
    ...
    category: "mobility",
    instruction:
      "Lift your foot. Draw slow, controlled circles with your ankle. 20 clockwise, 20 counter-clockwise.",
  ...
  calf_raises_slow: {
    ...
    category: "strength",
    instruction:
      "Rise up on your toes slowly (3 seconds up). Pause at the top. Lower slowly (3 seconds down).",
  ...
  landing_prep: {
    ...
    category: "plyometric",
    instruction:
      "Small jumps in place. Focus on landing softly and quietly. Bend your knees on landing.",
  ...
  toe_heel_rockers: {
    ...
    category: "mobility",
    instruction:
      "Stand with feet hip-width apart. Rock forward onto your toes, then back onto your heels. Keep it controlled.",
  ...
  fast_feet: {
    ...
    category: "speed",
    instruction:
      "Quick, light foot taps in place. Stay on the balls of your feet. Keep your core tight.",
  ...
  stick_the_stop: {
    ...
    instruction:
      "Take 2-3 quick steps forward, then stop suddenly and hold. Focus on absorbing into the floor.",
  ...
  snap_down: {
    ...
    category: "plyometric",
    instruction:
      "Start standing tall. Quick dip down into an athletic stance with soft knees. Arms back. Freeze.",
  ...
  silent_step_downs: {
    ...
    category: "control",
    instruction:
      "Stand on a low step or book. Step down with one foot, landing silently. Return and repeat.",
  ...
  pain_check: {
    ...
    category: "safety",
    instruction:
      "Take a moment. How does everything feel? Any sharp pain? Limping? If yes, stop here. If no, you're good.",
