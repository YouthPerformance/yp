...
export const LANE_STACKS = {
  ...
  STACK_BASE_8: {
    ...
    exercises: [
      ...
      buildExercise('short_foot_holds', { duration: 45, label: 'Short Foot Holds (Set 2)', id: 'short_foot_holds_2' }),
      buildExercise('single_leg_balance', { duration: 30, label: 'Single Leg Balance - Left', side: 'left' }),
      buildExercise('single_leg_balance', { duration: 30, label: 'Single Leg Balance - Right', side: 'right', id: 'single_leg_balance_right' }),
      ...
      buildExercise('ankle_circles', { duration: 40, label: 'Ankle Circles - Right', side: 'right', id: 'ankle_circles_right' }),
  ...
  STACK_QUIET_8: {
    ...
    exercises: [
      ...
      buildExercise('short_foot_holds', { duration: 30, label: 'Short Foot Holds (Set 2)', id: 'short_foot_holds_2' }),
      buildExercise('toe_heel_rockers', { duration: 45 }),
      buildExercise('single_leg_balance', { duration: 20, label: 'Single Leg Balance - Left', side: 'left' }),
      buildExercise('single_leg_balance', { duration: 20, label: 'Single Leg Balance - Right', side: 'right', id: 'single_leg_balance_right' }),
  ...
  STACK_SPEED_8: {
    ...
    exercises: [
      ...
      buildExercise('stick_the_stop', { duration: 45, label: 'Stick the Stop - Left', side: 'left' }),
      buildExercise('stick_the_stop', { duration: 45, label: 'Stick the Stop - Right', side: 'right', id: 'stick_the_stop_right' }),
    ].filter(Boolean),
  },
  ...
  STACK_JUMP_8: {
    ...
    exercises: [
      ...
      buildExercise('landing_prep', { duration: 45, reps: '5 more soft jumps', id: 'landing_prep_2' }),
    ].filter(Boolean),
  },
  ...
  STACK_RETURN_8: {
    ...
    exercises: [
      ...
      buildExercise('short_foot_holds', { duration: 30, label: 'Short Foot Holds (Set 1)' }),
      buildExercise('short_foot_holds', { duration: 30, label: 'Short Foot Holds (Set 2)', id: 'short_foot_holds_2' }),
      buildExercise('supported_single_leg_balance', { duration: 20, label: 'Supported Balance - Left', side: 'left' }),
      buildExercise('supported_single_leg_balance', { duration: 20, label: 'Supported Balance - Right', side: 'right', id: 'supported_balance_right' }),
