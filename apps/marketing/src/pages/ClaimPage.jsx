...
const PRODUCT_ICONS = {
  ...
  "foundation-42": (
    <svg viewBox="0 0 48 48" fill="none" className="w-16 h-16">
      <circle cx="24" cy="24" r="22" stroke="#00f6e0" strokeWidth="2" opacity="0.3" />
      <text x="24" y="30" textAnchor="middle" fill="#00f6e0" fontSize="16" fontWeight="bold">
        42
      </text>
    </svg>
  ),
        ...
        <div className="bg-gradient-to-b from-neutral-900 via-neutral-900 to-neutral-800 border-neutral-800 border rounded-3xl p-8 sm:p-10 relative shadow-2xl">
          ...
          {state === STATES.AUTH_REQUIRED && ticketData && (
            <div className="text-center">
              ...
              <h1 className="text-3xl font-bold text-white mb-2">{ticketData.productName}</h1>

              <p className="text-neutral-400 mb-2">Your training pack is ready to activate.</p>

              {getTimeRemaining() && (
                <p className="text-sm text-amber-400 font-mono mb-8">{getTimeRemaining()}</p>
              )}

              {/* Create YP ID CTA */}
              <div className="space-y-4">
                <Link to={`/login?claim=true&redirect=/claim/${token}`} className="block w-full">
                ...
                <p className="text-sm text-neutral-500">
                  ...
                  <Link
                    ...
                    className="text-[#00f6e0] hover:underline"
                  >
                    Lock In
                  </Link>
                </p>
          ...
          {state === STATES.READY && ticketData && (
            <div className="text-center">
              ...
              <p className="text-neutral-400 mb-8">One tap to unlock your training.</p>
          ...
          {state === STATES.SUCCESS && ticketData && (
            <div className="text-center py-4">
              ...
              <h1 className="text-3xl font-bold text-white mb-2">TRAINING UNLOCKED</h1>

              <p className="text-neutral-400 mb-2">
                <span className="text-[#00f6e0] font-semibold">{ticketData.productName}</span> is
                now active.
              </p>

              <p className="text-sm text-neutral-500 mb-8">Time to get after it.</p>
