    ...
    <div className="min-h-screen bg-black py-12">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <p className="text-dark-text-secondary mb-8">
          Browse all training programs and playbooks
        </p>
        ...
        <form onSubmit={handleSearch} className="flex flex-wrap gap-4 mb-8">
          ...
          <button type="submit" className="border border-white/30 text-white px-6 py-3 rounded-lg hover:bg-white/10 transition-colors">
            Search
          </button>
        </form>
        ...
        {loading ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[1, 2, 3, 4, 5, 6].map((i) => (
              <div key={i} className="bg-black-50 border border-black-400 rounded-xl p-4 animate-pulse">
