      ...
      <div className="relative z-10">
        ...
        <div className="space-y-3 mb-4">
          <div className="flex justify-between items-center mb-1">
            <span className="text-[8px] text-neutral-500 uppercase tracking-wider">Email address or username</span>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400 max-w-xl mx-auto">
              Modular "Layer Cake" architecture. Swap screen content without breaking 3D lighting or layout.
            </p>
          </div>
          ...
          <div className="bg-black/50 border border-gray-800 rounded-2xl p-8 max-w-2xl mx-auto">
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-center gap-3">
                <span className="w-8 h-8 bg-cyan-500/20 rounded flex items-center justify-center text-cyan-500 font-mono text-xs">L1</span>
                <span className="text-gray-400">RetroGrid - Atmosphere background</span>
              </div>
              <div className="flex items-center gap-3">
                <span className="w-8 h-8 bg-cyan-500/20 rounded flex items-center justify-center text-cyan-500 font-mono text-xs">L2</span>
                <span className="text-gray-400">Phone Chassis - Static frame (transparent screen)</span>
              </div>
              <div className="flex items-center gap-3">
                <span className="w-8 h-8 bg-cyan-500/20 rounded flex items-center justify-center text-cyan-500 font-mono text-xs">L3</span>
                <span className="text-gray-400">Screen Slot - Swappable content (image/video/code)</span>
              </div>
              <div className="flex items-center gap-3">
                <span className="w-8 h-8 bg-cyan-500/20 rounded flex items-center justify-center text-cyan-500 font-mono text-xs">L4</span>
                <span className="text-gray-400">Hologram VFX - Floating elements (Z-Index: 50)</span>
              </div>
            </div>
          </div>
