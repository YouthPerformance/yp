    ...
    return (
      <div className="min-h-screen bg-black py-12 flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-2xl font-yp-display uppercase tracking-wide text-white mb-4">Program Not Found</h1>
          <p className="text-dark-text-secondary mb-6">The program you're looking for doesn't exist or has been removed.</p>
          <Link to="/library" className="bg-cyan-500 hover:bg-cyan-600 text-black font-semibold px-8 py-3 rounded-lg transition-colors inline-block">
            Browse Programs
          </Link>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-black py-12">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <nav className="text-sm text-dark-text-tertiary mb-8 flex items-center flex-wrap gap-2">
          <Link to="/library" className="hover:text-cyan-500 transition-colors">Library</Link>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="aspect-video bg-black-50 rounded-xl mb-6 relative overflow-hidden group border border-black-400">
              {course.thumbnail_url ? (
                ...
                <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-black-100 to-black">
                  <svg className="w-20 h-20 text-dark-text-tertiary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="mb-8">
              <div className="flex items-center justify-between mb-4">
                <h2 className="text-xl font-yp-display uppercase tracking-wide text-white">Sessions</h2>
                ...
                {lectures.map((lecture, index) => (
                  ...
                  >
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        <span className={`block ${selectedLecture?.id === lecture.id ? 'text-cyan-500' : 'text-white'}`}>
                          {lecture.title}
                        </span>
                        {lecture.description && (
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <svg className="w-5 h-5 text-dark-text-tertiary" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M8 5v14l11-7z" />
                      </svg>
                    </div>
                  </div>
            ...
            {course.learning_objectives && (
              <div className="mb-8">
                <h2 className="text-xl font-yp-display uppercase tracking-wide text-white mb-4">What You'll Learn</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  {course.learning_objectives.split('\n').filter(obj => obj.trim()).map((objective, i) => (
                    <div key={i} className="flex items-start gap-3">
                      ...
                      <span className="text-dark-text-secondary">{objective.replace(/^[-•]\s*/, '')}</span>
                    </div>
                  ))}
                </div>
              </div>
          ...
          <div className="lg:col-span-1">
            ...
            >
              <h3 className="font-medium mb-4 text-dark-text-tertiary text-sm uppercase tracking-wide">Coach</h3>
              <div className="flex items-center space-x-4">
            ...
            <div className="bg-black-50 border border-black-400 rounded-xl p-6 mb-6">
              <h3 className="font-medium mb-4 text-dark-text-tertiary text-sm uppercase tracking-wide">Program Info</h3>
              <ul className="space-y-4 text-sm">
                <li className="flex items-center justify-between">
                  ...
                  <span className="font-medium text-white">{formatTotalDuration(course.total_duration_minutes)}</span>
                </li>
                <li className="flex items-center justify-between">
                  <span className="text-dark-text-secondary flex items-center gap-2">
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <span className="font-medium text-white">{course.lecture_count || lectures.length}</span>
                </li>
                <li className="flex items-center justify-between">
                  <span className="text-dark-text-secondary flex items-center gap-2">
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="bg-black-50 border border-cyan-500/30 rounded-xl p-6">
              ...
              <Link to="/pricing" className="bg-cyan-500 hover:bg-cyan-600 text-black font-semibold py-3 rounded-lg transition-colors w-full text-center block shadow-glow-cyan">
                Join the Campus
              </Link>
            </div>
          </div>
