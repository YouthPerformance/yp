    ...
    <div className="min-h-screen bg-black py-12">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <section className="mb-12">
          <h2 className="text-xl font-yp-display uppercase tracking-wide text-white mb-4">Continue Training</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[1, 2].map((i) => (
              <div key={i} className="bg-black-50 border border-black-400 rounded-xl p-4 hover:border-cyan-500/50 transition-colors cursor-pointer">
        ...
        {/* My Programs */}
        <section className="mb-12">
          <h2 className="text-xl font-yp-display uppercase tracking-wide text-white mb-4">My Programs</h2>
            ...
            {[
              ...
              <div key={i} className="bg-black-50 border border-black-400 rounded-xl p-4 hover:border-cyan-500/50 transition-colors cursor-pointer">
                ...
                <div className="mt-2 h-1 bg-black-400 rounded-full overflow-hidden">
                  <div className="h-full bg-cyan-500 rounded-full transition-all" style={{ width: `${program.progress}%` }}></div>
                </div>
              </div>
            ))}
          </div>
        ...
        {/* Stats */}
        <section>
          <h2 className="text-xl font-yp-display uppercase tracking-wide text-white mb-4">Your Progress</h2>
        ...
        <section className="mt-12">
          <h2 className="text-xl font-yp-display uppercase tracking-wide text-white mb-4">Quick Start</h2>
