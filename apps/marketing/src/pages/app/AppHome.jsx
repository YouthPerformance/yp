    ...
    <div className="min-h-screen bg-black">
        ...
        <div className="max-w-4xl mx-auto px-4 py-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <h1 className="text-2xl font-yp-display uppercase text-white">
                {user.name}
              </h1>
            </div>
      ...
      <div className="max-w-4xl mx-auto px-4 py-6">
        ...
        <Card variant="highlight" className="mb-6">
          <div className="flex items-start justify-between mb-4">
            <div>
              <Badge variant="cyan" size="sm">Current Program</Badge>
              ...
              <p className="text-dark-text-secondary text-sm mt-1">
                Week {user.currentProgram.currentLesson.week} • Day {user.currentProgram.currentLesson.day}
              </p>
            </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <Link to={`/app/lessons/${user.currentProgram.currentLesson.id}`} className="flex-1">
              <Button fullWidth>
                Continue: {user.currentProgram.currentLesson.title}
              </Button>
            </Link>
      ...
      <div className="max-w-4xl mx-auto px-4 py-6">
        ...
        <div className="space-y-4">
          ...
          <Card className="flex items-center gap-4 opacity-60">
            ...
            <Badge variant="gold" size="sm">Upgrade</Badge>
          </Card>
        </div>
      </div>
      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-black-100 border-t border-black-400 px-4 py-3">
        <div className="max-w-4xl mx-auto flex items-center justify-around">
          ...
          <Link to="/app/programs/barefoot-reset" className="flex flex-col items-center gap-1 text-dark-text-tertiary hover:text-white transition-colors">
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" />
            </svg>
            <span className="text-xs">Programs</span>
          </Link>
          <Link to="/settings" className="flex flex-col items-center gap-1 text-dark-text-tertiary hover:text-white transition-colors">
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
