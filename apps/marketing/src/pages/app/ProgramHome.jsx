...
const program = {
  id: 'barefoot-reset',
  name: 'Barefoot Reset',
  description: 'Build your foundation with the 4-week protocol that fixes force leaks, improves absorption, and creates bulletproof ankles.',
  totalWeeks: 4,
  totalLessons: 20,
  weeks: [
    {
    ...
    },
    {
      ...
      lessons: [
        ...
        { id: 'w2-d4', day: 4, title: 'Multi-Plane Stability', duration: '10 min', completed: false },
    ...
    },
    {
      ...
      lessons: [
        ...
        { id: 'w4-d5', day: 5, title: 'Assessment & Next Steps', duration: '10 min', completed: false },
      ],
    },
  ],
}
    ...
    >
      <div className="flex items-start justify-between mb-3">
        <div>
          ...
          <h3 className="text-lg font-yp-display uppercase text-white mt-2">
            {week.title}
          </h3>
        </div>
        {isLocked && (
      ...
      <div className="flex items-center justify-between text-sm">
        <span className="text-dark-text-tertiary">{completedCount}/{week.lessons.length} lessons</span>
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 text-left">
        <p className={`font-medium ${lesson.completed ? 'text-dark-text-secondary' : 'text-white'}`}>
...
function ProgramHome() {
  ...
  const getWeekStatus = (weekNumber) => {
    ...
    const prevProgress = prevWeek.lessons.filter((l) => l.completed).length / prevWeek.lessons.length
    return {
    ...
    <div className="min-h-screen bg-black">
      ...
      <header className="bg-black-50 border-b border-black-400">
        <div className="max-w-4xl mx-auto px-4 py-6">
          <Link to="/app" className="text-dark-text-secondary hover:text-white text-sm mb-4 inline-flex items-center gap-1">
          ...
          <div className="flex items-start justify-between">
            <div>
              <Badge variant="cyan" className="mb-2">Program</Badge>
              <h1 className="text-3xl font-yp-display uppercase text-white mb-2">
                {program.name}
              </h1>
              <p className="text-dark-text-secondary max-w-xl">
                {program.description}
              </p>
            </div>
          </div>
        ...
        <div>
          ...
          <div className="space-y-3">
            {selectedWeekData.lessons.map((lesson, idx) => {
              ...
              const isLessonLocked = weekStatus.isLocked || (prevLesson && !prevLesson.completed && !lesson.completed)
