...
const lessons = {
  "w1-d1": {
    ...
    description:
      "Learn the foundation of foot mechanics - the tripod position. This is the base for everything that follows.",
    steps: [
  ...
  "w1-d2": {
    ...
    videoUrl: null,
    description:
      "Build on the tripod with short foot exercises that strengthen your arch without equipment.",
    steps: [
...
function LessonPlayer() {
  ...
  const _hasTrackedStart = useRef(false);
      ...
      {showCelebration && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 animate-fadeIn">
          <div className="text-center">
            ...
            <h2 className="text-2xl font-yp-display uppercase text-white mb-2">Lesson Complete!</h2>
      ...
      <header className="bg-black-50 border-b border-black-400">
        <div className="max-w-4xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <Badge variant="cyan">
              Week {lesson.weekNumber} • Day {lesson.day}
            </Badge>
          </div>
        </div>
      </header>
