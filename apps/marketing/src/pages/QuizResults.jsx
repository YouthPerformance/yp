...
const identityContent = {
  'force-leaker': {
    title: 'Force Leaker',
    coldReading: "You look explosive in the first 10 minutes... then something weird happens. Your first step feels half a beat slower. Cuts feel a little sloppy. You're not gassed—your stabilizers are. The engine is strong. The base isn't sealing the power.",
    explanation: "When the foot/ankle system can't hold a clean position under speed, force leaks on every plant. That leak shows up as wobble, slower direction changes, and louder landings.",
    outcomes: [
      'Cuts feel sharper',
      'Stops feel cleaner',
  ...
  'elasticity-block': {
    ...
    coldReading: "You do the work. You grind. But you don't feel bouncy. You feel... stuck to the floor. Like your legs are strong, but your movement doesn't 'snap.' That's not effort—that's elastic timing missing at the base.",
    explanation: "Elasticity is the ability to load and return force smoothly. If the foot/ankle chain is stiff or mistimed, you lose spring and feel heavy even when you're strong.",
    outcomes: [
  ...
  'absorption-deficit': {
    ...
    coldReading: "Loud. Heavy. Sometimes your knees or shins feel 'worked' even when the session wasn't insane. That's because your body is taking impact the hard way—your feet aren't absorbing cleanly yet.",
    explanation: "Absorption is controlled deceleration. If the foot/ankle chain isn't absorbing force, impact travels upward and steals durability.",
    outcomes: [
  ...
  'control-gap': {
    title: 'Control Gap',
    coldReading: "You have days where you feel smooth... and days where you feel clunky for no reason. Same body. Same effort. Different result. That inconsistency is a control problem—your foot mechanics aren't 'online' every rep yet.",
    explanation: "Control is repeatability. If your base position changes rep to rep, your whole chain changes—so performance feels random.",
    outcomes: [
    ...
    <div className="min-h-screen bg-black py-12">
      <div className="max-w-2xl mx-auto px-4">
        ...
        <div className="text-center mb-10">
          <Badge variant="cyan" size="lg" className="mb-4">Your Athlete Type</Badge>
        ...
        {/* Plan - Gated */}
        <div className="mb-10">
          <h2 className="text-xl font-yp-display uppercase text-white mb-4">Your 7-Day Starter Plan</h2>
              ...
              <Card className="blur-sm select-none pointer-events-none">
                <ul className="space-y-3">
                  {content.fixPlanPreview.map((item, i) => (
                    <li key={i} className="text-dark-text-secondary">{item}</li>
                  ))}
                </ul>
              </Card>
