...
import { Button, Modal, ProgressBar, RadioCard, RadioGroup } from "./ui";
  ...
  gym: (
    <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path
        ...
        strokeLinejoin="round"
        strokeWidth={1.5}
        d="M4 8h2v8H4V8zm14 0h2v8h-2V8zM7 10h10v4H7v-4zM2 10h2v4H2v-4zm18 0h2v4h-2v-4z"
      />
    </svg>
  ),
  field: (
    <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path
        ...
        strokeLinejoin="round"
        strokeWidth={1.5}
        d="M4 4h16v16H4V4zm8 0v16M4 12h16"
      />
    </svg>
  ),
};
...
function RoleStep() {
  ...
  return (
    <div>
      ...
      <p className="text-dark-text-secondary mb-6">This helps us personalize your experience.</p>
...
function AgeStep() {
  ...
  return (
    <div>
      ...
      <p className="text-dark-text-secondary mb-6">This helps us adjust the training intensity.</p>
...
function SpaceStep() {
  ...
  return (
    <div>
      ...
      <p className="text-dark-text-secondary mb-6">We'll adjust exercises for your space.</p>
...
function PainStep() {
  ...
  return (
    <div>
      ...
      <p className="text-dark-text-secondary mb-6">This helps us keep training safe.</p>
      ...
      <div className="bg-black-200 rounded-xl p-4 mb-6">
        <p className="text-dark-text-tertiary text-sm">
          <span className="text-warning font-medium">Safety note:</span> If anything feels sharp or
          painful—stop the exercise and rest. This is not medical advice.
        </p>
      </div>
