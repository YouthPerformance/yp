...
const variants = {
  ...
  interactive:
    "bg-black-50 border border-black-400 hover:border-cyan-500/50 hover:scale-[1.02] cursor-pointer transition-all duration-200",
...
const Card = forwardRef(
  (
    { children, variant = "default", padding = "md", className = "", locked = false, ...props },
    ref,
  ) => {
    ...
    const classes = ["rounded-xl", variants[actualVariant], paddingClasses[padding], className]
      .filter(Boolean)
      .join(" ");
        ...
        {locked && (
          <div className="absolute inset-0 flex items-center justify-center bg-black/50 backdrop-blur-sm">
            <div className="text-center">
              <svg
                className="w-8 h-8 mx-auto mb-2 text-dark-text-tertiary"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
