...
const variants = {
  primary: 'bg-cyan-500 hover:bg-cyan-600 text-black font-semibold shadow-glow-cyan hover:shadow-glow-cyan transition-all',
...
const Button = forwardRef(({
  ...
  const baseClasses = 'inline-flex items-center justify-center font-medium focus:outline-none focus:ring-2 focus:ring-cyan-500/50 disabled:opacity-50 disabled:cursor-not-allowed'
