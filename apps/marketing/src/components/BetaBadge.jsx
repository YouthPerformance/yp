...
const variants = {
  ...
  glow: {
    container: 'bg-black border-cyan-500 text-cyan-500 shadow-[0_0_12px_rgba(0,246,224,0.15)] hover:shadow-[0_0_20px_rgba(0,246,224,0.4)] hover:bg-cyan-500/5',
    ping: 'bg-cyan-400',
    dot: 'bg-cyan-500'
  },
  holographic: {
    container: 'bg-black/80 backdrop-blur-md border-cyan-500/50 text-white shadow-[inset_0_0_10px_rgba(0,246,224,0.1)] hover:border-cyan-400 hover:text-cyan-400',
    ping: 'bg-cyan-400',
    dot: 'bg-cyan-500'
  }
}
