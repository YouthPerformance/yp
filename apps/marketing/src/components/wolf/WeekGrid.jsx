  ...
  return (
    <Card className="bg-black-100">
      ...
      <div className="flex items-center justify-between mb-4">
        <div>
          <h3 className="font-yp-display uppercase text-white text-lg">{plan.name}</h3>
        ...
        {plan.days.map((day, _idx) => {
          ...
          return (
            <button
              ...
              `}
            >
              <p className="text-[10px] text-dark-text-tertiary uppercase mb-1">{day.label}</p>
              <p className="text-lg">{isCompleted ? "✓" : config.icon}</p>
