...
export function ShopAllButton({
  ...
  return (
    <Link to={href} className={`shop-all-button group ${className}`} style={{width: size, height: size}}>
      {/* Rotating Text Ring */}
      <svg
        viewBox="0 0 100 100"
        className="shop-all-button__ring"
        aria-hidden="true"
      >
        <defs>
          <path
...
export function ShopAllButtonCompact({
  ...
  return (
    <ShopAllButton href={href} size={80} text={text} className={className} />
  );
}
...
export function ShopAllButtonLarge({
  ...
  return (
    <ShopAllButton href={href} size={140} text={text} className={className} />
  );
}
