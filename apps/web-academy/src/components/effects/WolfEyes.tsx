    ...
    >
      ...
      <div
        ...
        style={{
          ...
          left: -size,
          top: -size,
          background: `radial-gradient(circle, ${color}${Math.round(glowIntensity * 40)
            .toString(16)
      ...
      <div
        ...
        style={{
          ...
          left: -size / 2,
          top: -size / 2,
          background: `radial-gradient(circle, ${color}${Math.round(glowIntensity * 60)
            .toString(16)
            .padStart(2, "0")} 0%, transparent 70%)`,
...
export function WolfEyesTransition({
  ...
  if (phase === "eyes") {
    return <WolfEyes color={color} size="lg" glowIntensity={1.2} onComplete={handleEyesComplete} />;
  }
