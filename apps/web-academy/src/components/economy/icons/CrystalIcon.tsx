...
export function CrystalIcon({
  ...
  return (
    ...
    >
      ...
      {/* Top facet - brightest */}
      <path d="M12 1L21 6L12 9L3 6L12 1Z" fill={c.highlight} fillOpacity={0.8} />

      {/* Left facet */}
      <path d="M3 6L12 9V19L3 14V6Z" fill={c.primary} fillOpacity={0.7} />

      {/* Right facet - lighter */}
      <path d="M21 6L12 9V19L21 14V6Z" fill={c.secondary} fillOpacity={0.6} />

      {/* Bottom point */}
      <path d="M12 19L3 14L12 23L21 14L12 19Z" fill={c.shadow} fillOpacity={0.8} />

      {/* Center sparkle */}
      <circle cx="12" cy="10" r="1.5" fill="white" fillOpacity={0.6} />
      <circle cx="10" cy="8" r="0.75" fill="white" fillOpacity={0.4} />
    </svg>
  );
}
