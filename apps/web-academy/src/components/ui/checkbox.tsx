...
>(({ className, ...props }, ref) => (
  <CheckboxPrimitive.Root
    ...
    className={cn(
      ...
      "hover:border-accent-primary/50 hover:bg-white/10",
      "data-[state=checked]:bg-accent-primary data-[state=checked]:border-accent-primary data-[state=checked]:text-black",
      className
    )}
    {...props}
  >
