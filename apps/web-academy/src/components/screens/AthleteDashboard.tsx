...
const RANK_CONFIG: Record<
  WolfRank,
  { emoji: string; color: string; nextRank: WolfRank | null; threshold: number }
> = {
      ...
      >
          ...
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <div className="flex items-baseline gap-1">
                <span className="font-bebas text-5xl" style={{ color: "var(--text-primary)" }}>
                  {currentDay}
                </span>
                <span className="font-bebas text-2xl" style={{ color: "var(--text-tertiary)" }}>
                  /{totalDays}
                </span>
              </div>
            </div>
            ...
            <div className="text-right">
              ...
              <div className="flex items-center gap-2">
                <motion.span
                  ...
                  style={{
                    color: streakUrgent ? "var(--accent-warning)" : "var(--accent-primary)",
                  }}
        ...
        {isFreeUser && (
          <motion.button
            ...
            style={{
              background:
                "linear-gradient(135deg, rgba(0, 246, 224, 0.15) 0%, rgba(0, 163, 184, 0.15) 100%)",
