...
export function ProgramComplete({
  ...
  return (
    ...
    >
      ...
      <AnimatePresence>
        {showConfetti && (
          <div className="fixed inset-0 pointer-events-none">
            <Confetti colors={["#00F6E0", "#FBBF24", "#FFFFFF", "#FF6B6B"]} count={100} />
          </div>
        )}
      </AnimatePresence>
      ...
      {/* Wolf Eyes Phase */}
      <AnimatePresence>
        {phase === "eyes" && <WolfEyes color="#FBBF24" size="lg" glowIntensity={1.5} breathing />}
      </AnimatePresence>

      {/* Day Counter */}
      <AnimatePresence>
        {["day-counter", "impact", "stats", "confetti", "certificate", "complete"].includes(
          phase,
        ) && (
          <motion.div
        ...
        {["certificate", "complete"].includes(phase) && (
          ...
          >
            ...
            >
              ...
              <h2 className="font-bebas text-2xl tracking-wider mb-1" style={{ color: "#FBBF24" }}>
