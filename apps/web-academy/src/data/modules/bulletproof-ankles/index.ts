      ...
      options: [
        {
          id: "a",
          text: {
            athlete: "Is strong everywhere",
            parent: "Has balanced strength throughout the kinetic chain",
          },
          isCorrect: false,
          feedback: {
            athlete: "Not quite. There's a weak spot.",
            parent: "Incorrect. The defining feature is imbalance.",
          },
        },
        {
          id: "b",
          text: {
            athlete: "Has a powerful engine on a fragile foundation",
            parent: "Has developed proximal strength but distal vulnerability",
          },
          isCorrect: true,
          feedback: {
            athlete: "Exactly. Big engine, weak base. That's the problem we're fixing.",
            parent: "Correct. This proximal-distal imbalance is the core vulnerability we address.",
          },
        },
        {
          id: "c",
          text: {
            athlete: "Is slow but durable",
            parent: "Prioritizes injury prevention over performance",
          },
          isCorrect: false,
          feedback: {
            athlete: "Opposite — they're fast but breakable.",
            parent: "Incorrect. Glass Cannons are high-performing but vulnerable.",
          },
        },
        {
          id: "d",
          text: {
            athlete: "Only plays one sport",
            parent: "Specializes too early in a single sport",
          },
          isCorrect: false,
          feedback: {
            athlete: "Not about sports — it's about their foundation.",
            parent: "Incorrect. The term refers to structural imbalance, not sport specialization.",
          },
        },
      ],
      hintAvailable: true,
      ...
      options: [
        {
          ...
          isCorrect: false,
          feedback: {
            athlete: "That's where most TRAINING happens. Not where injuries happen.",
            parent: "Incorrect. This is where most training occurs, not where injuries occur.",
          },
        },
        {
          id: "b",
          ...
          isCorrect: true,
          feedback: {
            athlete: "Yes. That's why we train those angles specifically.",
            parent: "Correct. BPA specifically targets these injury-prone planes.",
          },
        },
        {
          id: "c",
          ...
          isCorrect: false,
          feedback: {
            athlete: "Forward movement rarely causes ankle rolls.",
            parent: "Incorrect. Linear forward movement rarely produces inversion mechanisms.",
          },
        },
        {
          id: "d",
          text: {
            athlete: "All directions equally",
            parent: "Evenly distributed across all planes",
          },
          isCorrect: false,
          feedback: {
            athlete: "Nope. There's a clear pattern — and that's what we train.",
            parent: "Incorrect. Injury patterns show clear directional clustering.",
          },
        },
      ],
      hintAvailable: true,
      ...
      options: [
        {
          ...
          isCorrect: false,
          feedback: {
            athlete: "There's a real reason — not just for fun.",
            parent: "Incorrect. The rationale is biomechanical, not motivational.",
          },
        },
        {
          id: "b",
          text: {
            athlete: "Stress there builds strength THERE",
            parent: "Tissue adaptation is angle-specific",
          },
          isCorrect: true,
          feedback: {
            athlete: "Exactly. Danger zone → strength zone. That's the whole concept.",
            parent: "Correct. Position-specific loading produces position-specific adaptation.",
          },
        },
        {
          id: "c",
          ...
          isCorrect: false,
          feedback: {
            athlete: "It's not about being tough — it's about being smart.",
            parent: "Incorrect. The goal is tissue adaptation, not pain exposure.",
          },
        },
        {
          id: "d",
          text: {
            athlete: "All angles are the same",
            parent: "Angular position is irrelevant to adaptation",
          },
          isCorrect: false,
          feedback: {
            athlete: "Angles matter a lot. That's the whole point of this section.",
            parent: "Incorrect. Research clearly demonstrates angle-specific adaptation.",
          },
        },
      ],
      hintAvailable: true,
      ...
      options: [
        {
          ...
          isCorrect: false,
          feedback: {
            athlete: "Opposite — isometrics have NO movement.",
            parent: "Incorrect. Isometrics are defined by the absence of joint movement.",
          },
        },
        {
          id: "b",
          ...
          isCorrect: true,
          feedback: {
            athlete: "Exactly. Maximum tension, zero movement. Safe and effective.",
            parent:
              "Correct. This allows high force production at specific, controlled joint angles.",
          },
        },
        {
          id: "c",
          ...
          isCorrect: false,
          feedback: {
            athlete: "Isometrics load ligaments and tendons too — that's the point.",
            parent: "Incorrect. Isometric loading stresses connective tissue as well as muscle.",
          },
        },
        {
          id: "d",
          ...
          isCorrect: false,
          feedback: {
            athlete: "You can start with just your bodyweight. No equipment needed.",
            parent: "Incorrect. Bodyweight isometrics require no equipment.",
          },
        },
      ],
      hintAvailable: true,
      ...
      options: [
        {
          ...
          isCorrect: false,
          feedback: {
            athlete: "There's a real biomechanical reason.",
            parent: "Incorrect. The rationale is biomechanical, not aesthetic.",
          },
        },
        {
          id: "b",
          text: {
            athlete: "It replicates sport G-forces",
            parent: "It replicates sport-specific loading patterns",
          },
          isCorrect: true,
          feedback: {
            athlete: "Yes! Train how you play. Floating heel = game-ready ankles.",
            parent: "Correct. This position specificity ensures transfer to athletic demands.",
          },
        },
        {
          id: "c",
          ...
          isCorrect: false,
          feedback: {
            athlete: "Actually, it makes it harder — that's the point.",
            parent: "Incorrect. Heel elevation increases, not decreases, stabilization demands.",
          },
        },
        {
          id: "d",
          text: {
            athlete: "It's just a personal preference",
            parent: "It's an optional stylistic choice",
          },
          isCorrect: false,
          feedback: {
            athlete: "Nope — it's a key part of the protocol for a reason.",
            parent: "Incorrect. It's a prescribed protocol element with specific rationale.",
          },
        },
      ],
      hintAvailable: true,
      ...
      options: [
        {
          ...
          isCorrect: false,
          feedback: {
            athlete: "Close — but that's Phase 2. Gotta wake up the sensors first.",
            parent: "Incorrect. Restore is Phase 2. Sensory preparation precedes loading.",
          },
        },
        {
          id: "b",
          ...
          isCorrect: true,
          feedback: {
            athlete: "Yes! Wake up the feet first, then build the armor.",
            parent: "Correct. Sensory restoration precedes and enables structural loading.",
          },
        },
        {
          id: "c",
          ...
          isCorrect: false,
          feedback: {
            athlete: "That's Phase 3 — the final step.",
            parent: "Incorrect. Re-Engineer is the final phase, building on Release and Restore.",
          },
        },
        {
          id: "d",
          ...
          isCorrect: false,
          feedback: {
            athlete: "Not one of the R's. Release, Restore, Re-Engineer.",
            parent: "Incorrect. The phases are Release, Restore, and Re-Engineer.",
          },
        },
      ],
      hintAvailable: true,
      ...
      options: [
        {
          ...
          isCorrect: false,
          feedback: {
            athlete: "Way more than that. Your foot is a sensor hub.",
            parent: "Incorrect. The foot has significantly higher receptor density.",
          },
        },
        {
          id: "b",
          ...
          isCorrect: false,
          feedback: {
            athlete: "Still too low. Think bigger.",
            parent: "Incorrect. The actual number is an order of magnitude higher.",
          },
        },
        {
          id: "c",
          ...
          isCorrect: true,
          feedback: {
            athlete: "That's it. 200,000 sensors — all waiting to help protect you.",
            parent:
              "Correct. This high receptor density enables the sophisticated proprioceptive capacity of the foot.",
          },
        },
        {
          id: "d",
          ...
          isCorrect: false,
          feedback: {
            athlete: "Not quite that many, but close energy!",
            parent: "Incorrect. While the foot is receptor-dense, this overestimates the count.",
          },
        },
      ],
      hintAvailable: true,
      ...
      options: [
        {
          id: "a",
          text: {
            athlete: "Wake up your sensors",
            parent: "Re-establish sensorimotor connections",
          },
          isCorrect: false,
          feedback: {
            athlete: "That's RELEASE. RESTORE is about building armor.",
            parent: "Incorrect. Sensory re-awakening is the Release phase objective.",
          },
        },
        {
          id: "b",
          text: {
            athlete: "Rebuild the half-dome architecture",
            parent: "Restore the medial longitudinal arch system",
          },
          isCorrect: true,
          feedback: {
            athlete: "Yes! Restore rebuilds the structural foundation of your foot.",
            parent: "Correct. Structural loading restores the foot's arch architecture.",
          },
        },
        {
          id: "c",
          ...
          isCorrect: false,
          feedback: {
            athlete: "That's RE-ENGINEER. RESTORE comes first.",
            parent: "Incorrect. Dynamic integration is the Re-Engineer phase objective.",
          },
        },
        {
          id: "d",
          ...
          isCorrect: false,
          feedback: {
            athlete: "RESTORE is active building, not resting.",
            parent: "Incorrect. Restore is an active loading phase, not a recovery phase.",
          },
        },
      ],
      hintAvailable: true,
...
export const moduleRegistry: Record<string, LearningModule> = {
  ...
  "bulletproof-ankles-teaser": bpaTeaser,
};

export const teaserRegistry: Record<string, TeaserModule> = {
  "bulletproof-ankles-teaser": bpaTeaser,
};
...
export function getTeaserBySlug(slug: string): TeaserModule | undefined {
  return teaserRegistry[slug];
}
...
export function getAllTeasers(): TeaserModule[] {
  return Object.values(teaserRegistry);
}
