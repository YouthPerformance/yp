...
import type { ProgramConfig, WorkoutDay, WorkoutTheme } from "./types";
...
export const PROGRAM: ProgramConfig = {
  ...
  description:
    "8-day foundation program for basketball athletes. Build mobility, stability, and explosive power.",
  totalDays: 8,
  dailyDuration: 15,
