  ...
  return (
    <article className="prose prose-invert prose-lg max-w-none">
      ...
      <header className="mb-12 not-prose">
        <p className="text-cyan-400 font-mono text-sm uppercase tracking-wider mb-2">Legal</p>
        <h1 className="font-bebas text-5xl md:text-6xl tracking-wide text-white mb-4">
          Terms of Service
        </h1>
        <p className="text-gray-400 font-mono text-sm">Last Updated: [Date]</p>
      </header>

      {/* Content */}
      <section className="space-y-8 text-gray-300">
        <div>
          <h2 className="text-2xl font-bebas tracking-wide text-white mb-4">1. Introduction</h2>
          <p>
            Welcome to Youth Performance ("YP", "we", "our", or "us"). These Terms of Service
            ("Terms") govern your access to and use of our website, mobile applications, and
            services including the Barefoot Reset training program (collectively, the "Services").
          </p>
          <p>
        ...
        <div>
          <h2 className="text-2xl font-bebas tracking-wide text-white mb-4">2. Eligibility</h2>
          <p>
            Our Services are designed for youth athletes and their parents or guardians. Users under
            18 years of age must have parental or guardian consent to use our Services.
          </p>
          <p>[Additional eligibility requirements to be added by legal counsel]</p>
        </div>

        <div>
          <h2 className="text-2xl font-bebas tracking-wide text-white mb-4">3. User Accounts</h2>
          <p>
        ...
        <div>
          <h2 className="text-2xl font-bebas tracking-wide text-white mb-4">5. Acceptable Use</h2>
          <p>
        ...
        <div>
          ...
          <p>
            The training programs and exercises provided through our Services are for informational
            and educational purposes only. Always consult with a healthcare provider before starting
        ...
        <div>
          <h2 className="text-2xl font-bebas tracking-wide text-white mb-4">9. Changes to Terms</h2>
          <p>
        ...
        <div>
          <h2 className="text-2xl font-bebas tracking-wide text-white mb-4">10. Contact Us</h2>
