    ...
    <article className="prose prose-invert prose-lg max-w-none">
      ...
      <section className="space-y-8 text-gray-300">
        <div>
          ...
          <p>
            Youth Performance ("YP", "we", "our", or "us") is committed to protecting your privacy.
            This Privacy Policy explains how we collect, use, disclose, and safeguard your
            information when you use our website, mobile applications, and services (collectively,
            the "Services").
          </p>
          <p>
        ...
        <div>
          <h2 className="text-2xl font-bebas tracking-wide text-white mb-4">6. Data Security</h2>
          <p>
        ...
        <div>
          <h2 className="text-2xl font-bebas tracking-wide text-white mb-4">7. Your Rights</h2>
          <p>
        ...
        <div>
          ...
          <p>
            ...
            activities and to personalize your experience. You can manage cookie preferences through
