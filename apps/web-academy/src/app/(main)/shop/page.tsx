        ...
        <div className="grid grid-cols-2 gap-3">
          {shopItems.map((item, i) => (
            ...
            >
              ...
              <h3 className="font-bebas tracking-wider" style={{ color: "var(--text-primary)" }}>
              ...
              <motion.button
                ...
                style={{
                  backgroundColor:
                    userCrystals >= item.price ? "var(--accent-gold)" : "var(--bg-tertiary)",
                  color: userCrystals >= item.price ? "var(--bg-primary)" : "var(--text-tertiary)",
                }}
          ...
          {crystalBundles.map((bundle, i) => (
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-mono font-bold" style={{ color: "var(--accent-gold)" }}>
