...
import { ArrowLeft, Clock, Lock, Star } from "lucide-react";
import { useRouter } from "next/navigation";
import { DayCard } from "@/components/programs/DayCard";
import { ProgramProgress } from "@/components/programs/ProgramProgress";
import { DAYS, getThemeColor, PROGRAM } from "@/data/programs/basketball-chassis";
import { getDayStatus, useProgramAccess } from "@/hooks/useProgramAccess";
  ...
  return (
    <main className="min-h-screen p-4 max-w-md mx-auto">
      ...
      <motion.div
        ...
        className="mb-6"
      >
        <ProgramProgress completedDays={completedDays.length} totalDays={PROGRAM.totalDays} />
      </motion.div>
