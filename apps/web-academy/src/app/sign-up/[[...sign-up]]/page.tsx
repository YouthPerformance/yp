...
/**
 * Sign Up Page - Clerk Elements + YP Design
 *
 * Uses Clerk Elements for auth logic with custom YP design.
 * Supports social auth (Google, Apple, Discord), email/password,
  ...
  return (
    <div className="min-h-screen antialiased flex items-center justify-center text-neutral-100 bg-transparent px-4 overflow-hidden relative">
      ...
      <div className="w-full max-w-5xl mx-auto my-8 relative">
        <SignUp.Root>
          {/* Start Step - Create account form */}
          <SignUp.Step name="start">
            <AuthCard>
              <AuthLogo />
              <AuthHeading title="Create an Account" subtitle="Train smarter. Play better. Every day." />
              ...
              <div className="mt-8 space-y-5">
                ...
                <p className="text-center text-sm text-neutral-400">
                  ...
                  <Link href="/sign-in" className="font-medium text-[#00f6e0] hover:text-[#00f6e0]/80">
                    Sign in
                  </Link>
                </p>
          ...
          {/* Continue Step - Additional info if needed */}
          <SignUp.Step name="continue">
            <AuthCard>
              <AuthLogo />
              <AuthHeading title="Complete your profile" subtitle="Just a few more details to get started." />
